...
if ( ! class_exists( 'Corporate_X_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Corporate_X_Demo {

		/**
		 * Singleton instance of Corporate_X_Demo.
		 *
		 * @var Corporate_X_Demo $instance Corporate_X_Demo instance.
		 */
		...
		/**
		 * Main Corporate_X_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Corporate_X_Demo ) ) {
				self::$instance = new Corporate_X_Demo();
