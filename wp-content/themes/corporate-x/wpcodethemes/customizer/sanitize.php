 ...
 */
function corporate_x_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function corporate_x_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function corporate_x_sanitize_email( $email, $setting ) {
 ...
 */
function corporate_x_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function corporate_x_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function corporate_x_sanitize_nohtml( $nohtml ) {
 ...
 */
function corporate_x_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function corporate_x_sanitize_number_range( $number, $setting ) {
 ...
 */
function corporate_x_sanitize_select( $input, $setting ) {
...
/**
 * Sanitize Text Containing HTML Tags.
 * @param $input
 * @return string
 */
function corporate_x_sanitize_textarea_code( $input ){
	$tag = array(
			'iframe' => array(
			'src' => array(),
			'width' => array(),
 ...
 * @return string
 */
function corporate_x_sanitize_text_a( $input ){
	$tag = array(
		'a' => array(
			'href' => array(),
			'target' => array()
 ...
 * @return int
 */
function corporate_x_sanitize_category($input){
	$output=intval($input);
	return $output;
}
 ...
 * @return string
 */
function corporate_x_sanitize_sidebar( $input ) {
	$valid = array(
		'left'   => 'Left',
		'right'  => 'Right',
		'none'	 => 'None',
